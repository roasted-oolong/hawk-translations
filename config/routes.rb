Rails.application.routes.draw do
  ...
  resources :novels, only: [ :index, :show, :new, :create, :edit, :update, :destroy ] do
    ...
    # PATCH /novels/:novel_id/chapter_review/chapters/:id/position → save scroll position (resume tracking)
    ...
    patch "chapter_review/chapters/:id/position",                      to: "chapter_review#update_position",    as: :update_chapter_review_position
